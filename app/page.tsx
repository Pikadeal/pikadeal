    ...
    <main className="min-h-screen bg-white font-sans">
      ...
      <nav className="flex items-center justify-between px-8 py-4 border-b border-gray-100">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 text-sm text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50">Connexion</button>
          <button className="px-4 py-2 text-sm bg-amber-400 text-amber-900 font-medium rounded-lg hover:bg-amber-500">Essai gratuit</button>
        </div>
      </nav>
      ...
      <section className="text-center py-20 px-8 bg-amber-50">
        ...
        <p className="text-gray-500 text-lg mb-8 max-w-lg mx-auto">
          PikaDeal surveille Vinted et eBay 24h/24 et t'envoie un email dès qu'une carte de ta liste apparaît sous le prix Cardmarket.
        </p>
        <div className="flex gap-3 justify-center">
          ...
          <button className="px-6 py-3 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50">Voir une démo</button>
        </div>
      </section>
      ...
      <section className="py-16 px-8 max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 mb-10">Une fois ta liste configurée, tu n'as plus rien à faire.</p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { icon: "🔔", title: "Alertes instantanées", desc: "Email dès qu'une carte apparaît" },
            { icon: "📊", title: "Score de deal", desc: "Comparaison auto avec Cardmarket" },
            { icon: "🌍", title: "Multi-plateformes", desc: "Vinted + eBay en même temps" },
            { icon: "🎯", title: "Filtres précis", desc: "État, pays vendeur, prix max" },
          ].map((f) => (
      ...
      <section className="py-16 px-8 bg-gray-50">
        <div className="max-w-lg mx-auto">
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-2">À quoi ressemble l'alerte</h2>
          <p className="text-center text-gray-500 mb-8">Un email clair, direct, avec tout ce qu'il faut pour décider vite.</p>
          <div className="bg-white rounded-xl border-l-4 border-amber-400 border border-gray-100 p-5 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">PikaDeal — Alerte carte trouvée</p>
                <p className="text-xs text-gray-400">alerte@pikadeal.fr · il y a 2 min</p>
              </div>
            </div>
            <p className="font-semibold text-gray-900 mb-4">✨ Charizard Holo — Base Set 1ère éd.</p>
            <div className="grid grid-cols-3 gap-3 mb-4">
              ...
              <div className="bg-green-50 rounded-lg p-3 text-center">
                <p className="text-xs text-green-600">Économie</p>
      ...
      <section className="py-16 px-8 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="border-2 border-amber-400 rounded-xl p-6 shadow-sm relative">
            <span className="absolute -top-3 left-4 bg-amber-400 text-amber-900 text-xs font-medium px-3 py-1 rounded-full">Recommandé</span>
      ...
      <footer className="text-center py-8 border-t border-gray-100 text-gray-400 text-sm">
        © 2025 PikaDeal — Fait avec ❤️ pour les dresseurs
      </footer>
